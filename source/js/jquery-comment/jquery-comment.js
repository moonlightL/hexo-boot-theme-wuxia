...
;(function($) {
    ...
    BeautyComment.prototype.registerCommentDataEvent = function() {
        ...
        let baseUrl = self.options.baseUrl;
        // 换头像，打开表情框，打开昵称框事件
        $(document).off("click", ".change-avatar,.emoji-container-btn,.emoji-close-btn,.input-container-btn")
                   .on("click", ".change-avatar,.emoji-container-btn,.emoji-close-btn,.input-container-btn", function (e) {
            let $target = $(e.target);
            if ($target.hasClass("change-avatar")) {
                ...
                $target.siblings("div").toggleClass("slideUp");
            } else if ($target.hasClass("emoji-close-btn")) {
                $target.parents(".emoji-content").toggleClass("slideUp");
        ...
        // 表情选择事件
        $(document).off("click", ".emoji-content-items ul li")
                   .on("click", ".emoji-content-items ul li", function () {
        ...
        // 发送评论事件
        $(document).off("click", "button.send-message-btn")
                   .on("click", "button.send-message-btn", function () {
    ...
    BeautyComment.prototype.registerCommentListEvent = function() {
        $(document).off("click", ".comment-list-body a.reply-btn")
                   .on("click", ".comment-list-body a.reply-btn", function () {
